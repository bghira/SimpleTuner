...
import os
if os.path.exists('/Users/kash/src/SimpleTuner'):
    sys.path.insert(0, '/Users/kash/src/SimpleTuner')
if os.path.exists('/Users/kash/src/SimpleTuner/tests'):
    sys.path.insert(0, '/Users/kash/src/SimpleTuner/tests')
