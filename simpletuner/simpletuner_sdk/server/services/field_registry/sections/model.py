...
def register_model_fields(registry: "FieldRegistry") -> None:
    ...
    registry._add_field(
        ConfigField(
            ...
            default_value=None,
            dependencies=sdnq_dependency,
            help_text="Enable SDNQ quantized matmul. Leave blank to follow SDNQ compile availability.",
            tooltip="Requires SDNQ torch compile/Triton support.",
            importance=ImportanceLevel.EXPERIMENTAL,
            order=23,
    ...
    registry._add_field(
        ConfigField(
            ...
            tooltip="Quantized matmul requires compile mode. Eager mode only supports dequantized matmul.",
            importance=ImportanceLevel.EXPERIMENTAL,
            order=24,
