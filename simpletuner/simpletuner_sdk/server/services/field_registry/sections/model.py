...
def register_model_fields(registry: "FieldRegistry") -> None:
    ...
    registry._add_field(
        ConfigField(
            ...
            subsection="advanced",
            default_value=None,
            placeholder="microsoft/Florence-2-large",
            ...
            tooltip="Provide a HuggingFace model ID (e.g., 'microsoft/Florence-2-large') for visual entity features from cropped bbox regions.",
            importance=ImportanceLevel.ADVANCED,
            order=36,
