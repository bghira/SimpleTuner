...
NOTE: This module was moved from routes/cloud/users.py to become a top-level
global route, as users are a global concept in SimpleTuner.
"""
...
# NOTE: /me routes MUST be defined before /{user_id} routes to ensure correct matching
