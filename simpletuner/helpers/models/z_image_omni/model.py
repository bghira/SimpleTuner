...
class ZImageOmni(ImageModelFoundation):
    ...
    def max_swappable_blocks(cls, config=None) -> Optional[int]:
        # Z-Image Omni has 30 transformer layers + 2 refiner layers
        return 31
    ...
    def get_acceleration_presets(cls) -> list[AccelerationPreset]:
        ...
        return [
            ...
            AccelerationPreset(
                ...
                description="Offloads all transformer and refiner layers to CPU RAM.",
                tab="basic",
            ...
            AccelerationPreset(
                ...
                description="Swaps 10 of 32 blocks between GPU and CPU.",
                tab="basic",
            ...
            AccelerationPreset(
                ...
                description="Swaps 16 of 32 blocks between GPU and CPU.",
                tab="basic",
            ...
            AccelerationPreset(
                ...
                description="Swaps 24 of 32 blocks between GPU and CPU.",
                tab="basic",
