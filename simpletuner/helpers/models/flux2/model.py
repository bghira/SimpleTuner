    ...
    def get_acceleration_presets(cls) -> list[AccelerationPreset]:
        return [
            ...
            AccelerationPreset(
                ...
                level="basic",
                name="RamTorch - Basic",
                description="Streams double blocks (8 of 56) from CPU RAM.",
                tab="basic",
            ...
            AccelerationPreset(
                ...
                level="light",
                name="RamTorch - Light",
                description="Streams double blocks + first 14 single blocks (22 of 56).",
                tab="basic",
            ...
            AccelerationPreset(
                ...
                description="Streams double blocks + first 24 single blocks (32 of 56).",
                tab="basic",
            ...
            AccelerationPreset(
                ...
                description="Streams double blocks + first 32 single blocks (40 of 56).",
                tab="basic",
            ...
            AccelerationPreset(
                ...
                description="Streams double blocks + first 40 single blocks (48 of 56).",
                tab="basic",
            ...
            # Block Swap presets - 6 levels for this 32B model
            AccelerationPreset(
                backend=AccelerationBackend.MUSUBI_BLOCK_SWAP,
                level="light",
                name="Block Swap - Light",
                description="Swaps 8 of 56 blocks (~15%).",
                tab="basic",
                tradeoff_vram="Reduces VRAM by ~12%",
            ...
            AccelerationPreset(
                ...
                description="Swaps 22 of 56 blocks (~40%).",
                tab="basic",
            ...
            AccelerationPreset(
                ...
                description="Swaps 42 of 56 blocks (~75%).",
                tab="basic",
            ...
            AccelerationPreset(
                ...
                description="Swaps 55 of 56 blocks (~98%).",
                tab="basic",
                tradeoff_vram="Reduces VRAM by ~85%",
