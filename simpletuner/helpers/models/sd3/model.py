    ...
    def get_acceleration_presets(cls) -> list[AccelerationPreset]:
        return [
            ...
            AccelerationPreset(
                ...
                level="basic",
                name="RamTorch - Basic",
                description="Streams first 3 of 18 transformer blocks from CPU RAM.",
                tab="basic",
            ...
            AccelerationPreset(
                ...
                level="light",
                name="RamTorch - Light",
                description="Streams first 6 of 18 transformer blocks from CPU RAM.",
                tab="basic",
            ...
            AccelerationPreset(
                ...
                description="Streams first 9 of 18 transformer blocks from CPU RAM.",
                tab="basic",
            ...
            AccelerationPreset(
                ...
                description="Streams first 12 of 18 transformer blocks from CPU RAM.",
                tab="basic",
            ...
            AccelerationPreset(
                ...
                description="Streams first 15 of 18 transformer blocks from CPU RAM.",
                tab="basic",
            ...
            AccelerationPreset(
                ...
                description="Swaps 3 of 18 blocks (~17%).",
                tab="basic",
                tradeoff_vram="Reduces VRAM by ~15%",
                tradeoff_speed="Increases training time by ~10%",
                tradeoff_notes="Requires 64GB+ system RAM.",
            ...
            AccelerationPreset(
                ...
                description="Swaps 7 of 18 blocks (~39%).",
                tab="basic",
            ...
            AccelerationPreset(
                ...
                description="Swaps 14 of 18 blocks (~78%).",
                tab="basic",
            ...
            AccelerationPreset(
                ...
                description="Swaps 17 of 18 blocks (~94%).",
                tab="basic",
                tradeoff_vram="Reduces VRAM by ~85%",
