...
from diffusers.loaders import FromSingleFileMixin, SD3IPAdapterMixin
...
from simpletuner.helpers.models.sd3.pipeline import SD3LoraLoaderMixin  # ControlNet LoRA capable version
...
class StableDiffusion3ControlNetPipeline(DiffusionPipeline, SD3LoraLoaderMixin, FromSingleFileMixin, SD3IPAdapterMixin):
    ...
    def __call__(
        ...
        controlnet_config = (
            self.controlnet.config if isinstance(self.controlnet, SD3ControlNetModel) else self.controlnet.nets[0].config
        )
