    ...
    def encode_prompt(
        ...
        if prompt_embeds is None:
            if self.text_encoder is None:
                raise ValueError(
                    "Prompt text embeddings were not provided, but the Stable Cascade prior text encoder has been "
        ...
        if text_encoder_dtype is None:
            raise ValueError(
                "Could not determine dtype for Stable Cascade prior embeddings. Ensure either the text encoder is "
