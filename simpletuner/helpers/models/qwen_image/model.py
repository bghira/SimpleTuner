    ...
    def get_acceleration_presets(cls) -> list[AccelerationPreset]:
        ...
        return [
            ...
            AccelerationPreset(
                ...
                level="basic",
                name="RamTorch - Basic",
                description="Streams first 10 of 60 transformer blocks from CPU RAM.",
                tab="basic",
            ...
            AccelerationPreset(
                ...
                level="light",
                name="RamTorch - Light",
                description="Streams first 20 of 60 transformer blocks from CPU RAM.",
                tab="basic",
            ...
            AccelerationPreset(
                ...
                description="Streams first 30 of 60 transformer blocks from CPU RAM.",
                tab="basic",
            ...
            AccelerationPreset(
                ...
                description="Streams first 40 of 60 transformer blocks from CPU RAM.",
                tab="basic",
            ...
            AccelerationPreset(
                ...
                description="Streams first 50 of 60 transformer blocks from CPU RAM.",
                tab="basic",
            ...
            # Block Swap presets - 6 levels for this 20B model
            AccelerationPreset(
                backend=AccelerationBackend.MUSUBI_BLOCK_SWAP,
                level="light",
                name="Block Swap - Light",
                description="Swaps 10 of 60 blocks (~17%).",
                tab="basic",
                tradeoff_vram="Reduces VRAM by ~15%",
                tradeoff_speed="Increases training time by ~10%",
                tradeoff_notes="Requires 64GB+ system RAM.",
            ...
            AccelerationPreset(
                ...
                description="Swaps 24 of 60 blocks (~40%).",
                tab="basic",
            ...
            AccelerationPreset(
                ...
                description="Swaps 45 of 60 blocks (~75%).",
                tab="basic",
            ...
            AccelerationPreset(
                ...
                description="Swaps 59 of 60 blocks (~98%).",
                tab="basic",
                tradeoff_vram="Reduces VRAM by ~85%",
