    ...
    def get_acceleration_presets(cls) -> list[AccelerationPreset]:
        ...
        return [
            ...
            AccelerationPreset(
                ...
                level="basic",
                name="RamTorch - Basic",
                description="Streams first 20 of 40 transformer block weights from CPU RAM.",
                tab="basic",
            ...
            AccelerationPreset(
                ...
                description="Swaps 10 of 40 blocks (~25%).",
                tab="basic",
            ...
            AccelerationPreset(
                ...
                description="Swaps 20 of 40 blocks (~50%).",
                tab="basic",
            ...
            AccelerationPreset(
                ...
                description="Swaps 30 of 40 blocks (~75%).",
                tab="basic",
