...
#
# Originally from diffusers.models.transformers.transformer_omnigen
    ...
    def _get_multimodal_embeddings(
        ...
        for b_inx in input_image_sizes.keys():
            for start_inx, end_inx in input_image_sizes[b_inx]:
                ...
                condition_tokens[b_inx, start_inx:end_inx] = input_image_tokens[input_img_inx].to(condition_tokens.dtype)
                input_img_inx += 1
