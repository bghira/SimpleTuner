...
class Cosmos2Image(VideoModelFoundation):
    ...
    def max_swappable_blocks(cls, config=None) -> Optional[int]:
        # Cosmos2 has 28 transformer blocks
    ...
    def get_acceleration_presets(cls) -> list[AccelerationPreset]:
        ...
        return [
            ...
            AccelerationPreset(
                ...
                level="basic",
                name="RamTorch - Basic",
                description="Streams first 5 of 28 transformer blocks from CPU RAM.",
                tab="basic",
            ...
            AccelerationPreset(
                ...
                level="light",
                name="RamTorch - Light",
                description="Streams first 10 of 28 transformer blocks from CPU RAM.",
                tab="basic",
            ...
            AccelerationPreset(
                ...
                description="Streams first 14 of 28 transformer blocks from CPU RAM.",
                tab="basic",
            ...
            AccelerationPreset(
                ...
                description="Streams first 18 of 28 transformer blocks from CPU RAM.",
                tab="basic",
            ...
            AccelerationPreset(
                ...
                description="Streams first 22 of 28 transformer blocks from CPU RAM.",
                tab="basic",
            ...
            # Block Swap presets - 6 levels for this 14B model
            AccelerationPreset(
                backend=AccelerationBackend.MUSUBI_BLOCK_SWAP,
                level="light",
                name="Block Swap - Light",
                description="Swaps 5 of 28 blocks (~18%).",
                tab="basic",
                tradeoff_vram="Reduces VRAM by ~15%",
                tradeoff_speed="Increases training time by ~10%",
                tradeoff_notes="Requires 64GB+ system RAM.",
            ...
            AccelerationPreset(
                ...
                description="Swaps 11 of 28 blocks (~40%).",
                tab="basic",
            ...
            AccelerationPreset(
                ...
                description="Swaps 27 of 28 blocks (~96%).",
                tab="basic",
                tradeoff_vram="Reduces VRAM by ~85%",
