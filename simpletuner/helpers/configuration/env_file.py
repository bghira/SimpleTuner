...
env_to_args_map = {
    ...
    "GRADIENT_CHECKPOINTING_OFFLOAD_ATTENTION": "--gradient_checkpointing_offload_attention",
    "GRADIENT_CHECKPOINTING_OFFLOAD_PREFETCH": "--gradient_checkpointing_offload_prefetch",
    "GRADIENT_CHECKPOINTING_OFFLOAD_PIN_MEMORY_MAX_BUCKETS": "--gradient_checkpointing_offload_pin_memory_max_buckets",
    ...
    "DEEPFLOYD_VALIDATION_PIPELINE_MODE": "--deepfloyd_validation_pipeline_mode",
    "DEEPFLOYD_VALIDATION_STAGE1_MODEL": "--deepfloyd_validation_stage1_model",
    "DEEPFLOYD_VALIDATION_STAGE2_MODEL": "--deepfloyd_validation_stage2_model",
    "DEEPFLOYD_VALIDATION_STAGE3_MODE": "--deepfloyd_validation_stage3_mode",
    "DEEPFLOYD_VALIDATION_STAGE3_MODEL": "--deepfloyd_validation_stage3_model",
    "DEEPFLOYD_VALIDATION_STAGE1_NUM_INFERENCE_STEPS": "--deepfloyd_validation_stage1_num_inference_steps",
    "DEEPFLOYD_VALIDATION_STAGE2_NUM_INFERENCE_STEPS": "--deepfloyd_validation_stage2_num_inference_steps",
    "DEEPFLOYD_VALIDATION_STAGE1_GUIDANCE": "--deepfloyd_validation_stage1_guidance",
    ...
    "SDXL_VALIDATION_PIPELINE_MODE": "--sdxl_validation_pipeline_mode",
    "SDXL_VALIDATION_STAGE1_MODEL": "--sdxl_validation_stage1_model",
    "SDXL_VALIDATION_STAGE2_MODEL": "--sdxl_validation_stage2_model",
    "PIXART_VALIDATION_PIPELINE_MODE": "--pixart_validation_pipeline_mode",
    "PIXART_VALIDATION_STAGE1_MODEL": "--pixart_validation_stage1_model",
    "PIXART_VALIDATION_STAGE2_MODEL": "--pixart_validation_stage2_model",
    ...
    "SDNQ_QUANTIZED_MATMUL_DTYPE": "--sdnq_quantized_matmul_dtype",
    "SDNQ_GROUP_SIZE": "--sdnq_group_size",
    "SDNQ_USE_QUANTIZED_MATMUL": "--sdnq_use_quantized_matmul",
    "SDNQ_COMPILE_MODE": "--sdnq_compile_mode",
    "SDNQ_USE_STATIC_QUANTIZATION": "--sdnq_use_static_quantization",
    "SDNQ_USE_STOCHASTIC_ROUNDING": "--sdnq_use_stochastic_rounding",
    "SDNQ_DEQUANTIZE_FP32": "--sdnq_dequantize_fp32",
    "SDNQ_USE_SVD": "--sdnq_use_svd",
    "SDNQ_SVD_RANK": "--sdnq_svd_rank",
    "SDNQ_SVD_STEPS": "--sdnq_svd_steps",
    "SDNQ_USE_HADAMARD": "--sdnq_use_hadamard",
    "SDNQ_HADAMARD_GROUP_SIZE": "--sdnq_hadamard_group_size",
    "SDNQ_MODULES_TO_NOT_CONVERT": "--sdnq_modules_to_not_convert",
    "SDNQ_MODULES_TO_NOT_USE_MATMUL": "--sdnq_modules_to_not_use_matmul",
    "SDNQ_MODULES_DTYPE_DICT": "--sdnq_modules_dtype_dict",
    "SDNQ_MODULES_QUANT_CONFIG": "--sdnq_modules_quant_config",
