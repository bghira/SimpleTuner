...
def cmd_users(args) -> int:
    ...
    if users_action == "list":
        ...
        print("Error: Unknown users action. Use 'simpletuner auth users --help'.")
        return 1
...
def _users_update(args) -> int:
    ...
    cloud_api_request("PATCH", f"/api/users/{user_id}", data=data)
...
def _users_levels(args) -> int:
    ...
    if levels_action == "list":
        ...
        cloud_api_request("PUT", f"/api/users/levels/{level_id}", data=data)
        ...
        cloud_api_request("DELETE", f"/api/users/levels/{level_id}")
...
def _users_rules(args) -> int:
    ...
    if rules_action == "list":
        ...
        cloud_api_request("PUT", f"/api/users/resource-rules/{rule_id}", data=data)
        ...
        cloud_api_request("DELETE", f"/api/users/resource-rules/{rule_id}")
        ...
        cloud_api_request("POST", f"/api/users/levels/{level_id}/rules/{rule_id}")
        ...
        cloud_api_request("DELETE", f"/api/users/levels/{level_id}/rules/{rule_id}")
