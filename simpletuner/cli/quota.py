...
def cmd_quota(args) -> int:
    ...
    if quota_action == "list":
        return _quota_list(args)
    elif quota_action == "create":
        return _quota_create(args)
    elif quota_action == "delete":
        return _quota_delete(args)
    elif quota_action == "status":
        return _quota_status(args)
    elif quota_action == "types":
        return _quota_types(args)
    else:
        print("Error: Unknown quota action. Use 'simpletuner quota --help'.")
        return 1


def _quota_list(args) -> int:
