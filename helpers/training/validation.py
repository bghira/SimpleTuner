        ...
        for resolution in self.validation_resolutions:
            ...
            try:
                ...
                for current_validation_type in validation_types:
                    ...
                    if hasattr(all_validation_type_results[current_validation_type], "images"):
                      all_validation_type_results[current_validation_type] = all_validation_results[current_validation_type].images
