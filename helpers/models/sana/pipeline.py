...
class SanaImg2ImgPipeline(DiffusionPipeline, SanaLoraLoaderMixin):
    ...
    def _clean_caption(self, caption):
        ...
        # remove CJK / special unicode blocks
        ...
        # handle underscores/hyphens if too many
        ...
        # remove weird alpha-numeric combos
