...
-   :material-flask-outline:{ .lg .middle } __实验方法__
    ...
    AnyFlow、ConvRot 风格的 SDNQ Hadamard 量化、segmented checkpointing、Unsloth 风格 checkpointing、Prompt2Effect、Self-Flow、Flow-DPO、Internal Guidance、LayerSync、Diff2Flow、Metal Flash Attention、Video CREPA 等研究功能
