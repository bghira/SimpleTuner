...
- **Hub リンク**: [terminusresearch/nijijourney-v6-520k-raw](https://huggingface.co/datasets/terminusresearch/nijijourney-v6-520k-raw)
- **説明**: 約 520,000 枚の高品質出力。日本語ユーザープロンプトは GPT-3.5-Turbo によって再キャプションされています。
- **キャプション形式**: Parquet
