...
-   :material-flask-outline:{ .lg .middle } __एक्सपेरिमेंटल मेथड्स__
    ...
    AnyFlow, ConvRot-style SDNQ Hadamard quantization, segmented checkpointing, Unsloth-style checkpointing, Prompt2Effect, Self-Flow, Flow-DPO, Internal Guidance, LayerSync, Diff2Flow, Metal Flash Attention और Video CREPA जैसी research features
