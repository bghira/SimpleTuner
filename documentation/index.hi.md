...
-   :material-shield-check:{ .lg .middle } __NSFW checks__
    ...
    Local classifier policies से VAE cache samples filter करें

    [:octicons-arrow-right-24: NSFW classifier checks](NSFW.hi.md)
...
-   :material-flask-outline:{ .lg .middle } __एक्सपेरिमेंटल मेथड्स__
    ...
    AnyFlow, MixFlow, ConvRot-style SDNQ Hadamard quantization, segmented checkpointing, Unsloth-style checkpointing, Prompt2Effect, Self-Flow, Self-Transcendence, Flow-DPO, Internal Guidance, iREPA, LayerSync, Diff2Flow, Metal Flash Attention और Video CREPA जैसी research features
