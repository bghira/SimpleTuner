...
_Este arquivo e gerado automaticamente por `scripts/generate-webhook-documentation.py`. Nao edite manualmente._

## lifecycle.stage

| Chave do estagio | Status | Rotulo | Mensagem | Severidade | Origem |
| --- | --- | --- | --- | --- | --- |
...
| Status | Mensagem | Severidade | Origem |
| --- | --- | --- | --- |
...
| Mensagem | Titulo | Severidade | Origem |
| --- | --- | --- | --- |
...
| Rotulo | Caminho | Final | Severidade | Origem |
| --- | --- | --- | --- | --- |
