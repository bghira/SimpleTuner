...
-   :material-flask-outline:{ .lg .middle } __Métodos experimentais__
    ...
    Recursos de pesquisa como AnyFlow, quantização SDNQ Hadamard no estilo ConvRot, checkpointing segmentado, checkpointing estilo Unsloth, Prompt2Effect, Self-Flow, Self-Transcendence, Flow-DPO, iREPA, LayerSync, Diff2Flow, Metal Flash Attention e Video CREPA
