...
- Como cada lote (batch) vem de um único dataset, agrupe as imagens por granularidade semântica em datasets separados e defina um `timestep_bias` para cada um.
