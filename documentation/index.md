...
-   :material-flask-outline:{ .lg .middle } __Experimental Methods__
    ...
    Research features such as AnyFlow, DiffusionBlocks, ConvRot-style SDNQ Hadamard quantization, segmented checkpointing, Unsloth-style checkpointing, Prompt2Effect, Self-Flow, Flow-DPO, LayerSync, Diff2Flow, Metal Flash Attention, and Video CREPA
