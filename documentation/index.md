...
-   :material-flask-outline:{ .lg .middle } __Experimental Methods__
    ...
    Research features such as AnyFlow, ConvRot-style SDNQ Hadamard quantization, segmented checkpointing, Unsloth-style checkpointing, Prompt2Effect, Self-Flow, Self-Transcendence, Flow-DPO, iREPA, LayerSync, Diff2Flow, Metal Flash Attention, and Video CREPA
