...
-   :material-flask-outline:{ .lg .middle } __Métodos experimentales__
    ...
    Funciones de investigación como AnyFlow, cuantización SDNQ Hadamard estilo ConvRot, checkpointing segmentado, checkpointing estilo Unsloth, Prompt2Effect, Self-Flow, Flow-DPO, Internal Guidance, LayerSync, Diff2Flow, Metal Flash Attention y Video CREPA
