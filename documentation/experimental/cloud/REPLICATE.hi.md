...
|----------|------|------|----------|
| H100 | 80GB | Replicate pricing देखें | बड़े मॉडल, full fine-tuning |
| L40S | 48GB | Replicate pricing देखें | छोटे LoRA training |

WebUI submit modal में हर job के लिए hardware profile चुना जा सकता है। CLI से:
