...
- Because each batch is drawn from a single dataset, group images by semantic granularity into separate datasets and set a per-dataset `timestep_bias` on each.
