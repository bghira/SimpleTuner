...
केवल ऑडियो मोड में:
- वीडियो latents अपने आप शून्य हो जाते हैं
- वीडियो loss मास्क हो जाता है (गणना नहीं होती)
- केवल ऑडियो जेनरेशन ट्रेन होता है
...
मुख्य सेटिंग `audio.audio_only: true` है, जो SimpleTuner को निर्देश देती है:
1. Audio VAE का उपयोग करके ऑडियो latents कैश करें
2. ऑडियो duration से मिलते‑जुलते शून्य वीडियो latents जेनरेट करें
3. ट्रेनिंग के दौरान वीडियो loss मास्क करें

अपनी ऑडियो फाइलें (`.wav`, `.flac`, `.mp3`, आदि) `instance_data_dir` में रखें और संबंधित `.txt` कैप्शन फाइलें प्रदान करें।
