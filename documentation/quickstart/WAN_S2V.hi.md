...
S2V ट्रेनिंग के लिए वीडियो और ऑडियो डेटा जोड़े में होना चाहिए। आपको एक वीडियो डेटासेट और एक संबंधित ऑडियो डेटासेट चाहिए जो `s2v_datasets` के माध्यम से जुड़े हों।
...
अगर आपके वीडियो में पहले से ऑडियो ट्रैक हैं, तो SimpleTuner अलग ऑडियो डेटासेट की जरूरत के बिना ऑडियो स्वतः एक्सट्रैक्ट और प्रोसेस कर सकता है। यह सबसे सरल तरीका है:
...
`audio.auto_split: true` होने पर, SimpleTuner:
...
- `audio.auto_split` (bool): वीडियो से ऑडियो की ऑटोमैटिक एक्सट्रैक्शन सक्षम करें
...
अगर आप अलग ऑडियो फाइलें रखना चाहते हैं या कस्टम ऑडियो प्रोसेसिंग चाहिए, तो S2V मॉडल प्री-एक्सट्रैक्टेड ऑडियो फाइलों का भी उपयोग कर सकते हैं जो आपके वीडियो फाइलों से नाम के आधार पर मेल खाती हों। उदाहरण के लिए:
