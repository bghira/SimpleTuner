...
[Ostris ने मॉडल की अपनी बनाई छवियों पर कम लर्निंग रेट से प्रशिक्षण का वर्णन किया है](https://huggingface.co/ostris/zimage_turbo_training_adapter)। यहाँ सकारात्मक अडैप्टर प्रशिक्षित होता है। बाद के कॉन्सेप्ट रन में `assistant_lora_path` को सहेजे गए अडैप्टर पर सेट करें और सहायक लोडिंग चालू करें। SimpleTuner इसे प्रशिक्षण में स्थिर रखता है और सैंपलिंग में हटाता है। Qwen 2.1 के लिए कोई डिफ़ॉल्ट सहायक डाउनलोड नहीं होता; लाभ अभी प्रयोगात्मक है।
