...
如果您没有现成的 `.bbox` 标注文件，可以让 SimpleTuner 使用 [Florence-2](https://huggingface.co/microsoft/Florence-2-large) 自动生成。在 `grounding` 配置中添加 `auto_detect` 块：
...
| `model` | `microsoft/Florence-2-large` | HuggingFace Florence-2 模型 ID。 |
