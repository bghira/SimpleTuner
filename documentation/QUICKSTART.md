...
| InfiniteTalk | 14B | [INFINITETALK.md](/documentation/quickstart/INFINITETALK.md) |
...
| MiniMax H3 | 33B | [MINIMAX_H3.md](/documentation/quickstart/MINIMAX_H3.md) |
...
| Qwen Image 2.1 / Qwen Image | 2.1: optional; v1.0/v2.0: int8/nf4 | bf16 |
...
| Model | Prediction | Flow Shift | TwinFlow | Self-Flow | LayerSync | NextLat | XM | Internal Guidance | Sliders |
| --- | --- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
...
| InfiniteTalk | UMT5 + Wav2Vec2 | not specified + 95M | Wan VAE |
...
*TwinFlow support is native when `twinflow_enabled=true`; diffusion models still require `diff2flow_enabled=true` plus `twinflow_allow_diff2flow=true`. Self-Flow refers to CREPA self-flow support. Internal Guidance covers diffusion transformers with an auxiliary denoising head. LayerSync marks backbones that expose hidden states for alignment. NextLat uses captured hidden states for the auxiliary next-latent objective. XM marks Explorative Modeling support: noise-candidate selection for diffusion models and route selection for autoregressive token models.*
