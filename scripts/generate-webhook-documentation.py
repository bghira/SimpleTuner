...
- ``documentation/api/WEBHOOKS.md`` (English)
- ``documentation/api/WEBHOOKS.ja.md`` (Japanese)
- ``documentation/api/WEBHOOKS.zh.md`` (Chinese)
"""
...
TRANSLATIONS = {
    "en": {
        ...
        "auto_gen_notice": "_This file is auto-generated by `scripts/generate-webhook-documentation.py`. Do not edit manually._",
    },
    "ja": {
        "title": "Webhook イベント参照",
        "auto_gen_notice": "_このファイルは `scripts/generate-webhook-documentation.py` により自動生成されます。手動で編集しないでください。_",
    },
    "zh": {
        "title": "Webhook 事件参考",
        "auto_gen_notice": "_此文件由 `scripts/generate-webhook-documentation.py` 自动生成。请勿手动编辑。_",
    },
}
...
def build_markdown(events: Mapping[str, List[EventRecord]], lang: str = "en") -> str:
    translations = TRANSLATIONS.get(lang, TRANSLATIONS["en"])
    lines: List[str] = []
    lines.append(f"# {translations['title']}")
    lines.append("")
    lines.append(translations["auto_gen_notice"])
    lines.append("")
...
def main() -> None:
    ...
    for lang in TRANSLATIONS.keys():
        ...
        output_path = OUTPUT_DIR / f"WEBHOOKS{suffix}"
        markdown = build_markdown(events, lang)
