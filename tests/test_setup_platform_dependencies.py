...
class SetupPlatformDependencyTests(unittest.TestCase):
    def test_base_dependencies_require_trainingsample_0_2_18(self):
        install_requires = load_setup_kwargs()["install_requires"]

        self.assertIn("trainingsample>=0.2.18", install_requires)
        self.assertNotIn("trainingsample>=0.2.10", install_requires)
