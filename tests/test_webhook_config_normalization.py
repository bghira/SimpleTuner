...
class TestWebhookConfigNormalization(unittest.TestCase):
    ...
    def test_none_webhook_config(self):
        ...
        config = ConfigModel(trainer_config={}, dataloader_config=[], webhook_config=None, job_id="test_none")
    ...
    def test_dict_webhook_config(self):
        ...
        webhook_dict = {"webhook_type": "discord", "webhook_url": "http://discord.com/webhook", "log_level": "info"}
        config = ConfigModel(trainer_config={}, dataloader_config=[], webhook_config=webhook_dict, job_id="test_dict")
        self.assertIsInstance(config.webhook_config, list)
    ...
    def test_list_webhook_config(self):
        ...
        config = ConfigModel(trainer_config={}, dataloader_config=[], webhook_config=webhook_list, job_id="test_list")
        self.assertIsInstance(config.webhook_config, list)
    ...
    def test_empty_list_webhook_config(self):
        ...
        config = ConfigModel(trainer_config={}, dataloader_config=[], webhook_config=[], job_id="test_empty_list")
        self.assertEqual(config.webhook_config, [])
        self.assertIsInstance(config.webhook_config, list)
    ...
    def test_invalid_webhook_config_type(self):
        ...
        with self.assertRaises(ValueError) as context:
            ConfigModel(trainer_config={}, dataloader_config=[], webhook_config="invalid_string", job_id="test_invalid")
    ...
    def test_backward_compatibility_with_empty_dict(self):
        ...
        config = ConfigModel(trainer_config={}, dataloader_config=[], webhook_config={}, job_id="test_empty_dict")
        self.assertIsInstance(config.webhook_config, list)
        self.assertEqual(len(config.webhook_config), 1)
