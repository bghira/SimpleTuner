...
class TestAnimaModel(unittest.TestCase):
    ...
    def test_xm_noise_candidates_expand_anima_conditioning_candidate_major(self):
        ...
        batch = {
            ...
            "t5xxl_ids": torch.arange(2 * 5, dtype=torch.int32).view(2, 5),
            "t5xxl_weights": torch.ones(2, 5),
        }

        model._prepare_xm_noise_candidates(batch, family_name="Anima")
        ...
        self.assertEqual(tuple(batch["t5xxl_ids"].shape), (6, 5))
    ...
    def test_xm_loss_selects_winners_and_trims_anima_hidden_states(self):
