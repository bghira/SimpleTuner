...
class ZlabI1FeatureTests(unittest.TestCase):
    ...
    def test_xm_noise_candidates_expand_candidate_major(self):
        ...
        batch = {
            ...
            "prompt_embeds": torch.randn(2, 4, 6),
            "attention_mask": torch.ones(2, 4, dtype=torch.bool),
        }

        model._prepare_xm_noise_candidates(batch, family_name=ZLabI1.NAME)
    ...
    def test_xm_loss_selects_winners_with_inverted_flow_target(self):
