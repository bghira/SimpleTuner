...
- **CaptionFlow 集成** - 通过 Web UI 作业队列使用本地 GPU 和 [bghira/CaptionFlow](https://github.com/bghira/CaptionFlow) 生成数据集 captions；参见 [CaptionFlow 集成指南](/documentation/CAPTIONFLOW.zh.md)
