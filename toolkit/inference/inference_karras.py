...
pipe = StableDiffusionKDiffusionPipeline.from_pretrained('/models/pseudo-test', 
...
pipe.vae = vae
pipe.to('cuda')
image = pipe(prompt='best quality ((bear)) in the swiss alps cinematic 8k highly detailed sharp focus intricate fur',
    negative_prompt='malformed, disgusting',
    num_inference_steps=50, generator=torch.Generator(device='cuda').manual_seed(42), 
    width=1280, height=720, guidance_scale=3.0,
